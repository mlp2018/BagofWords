...
def main():
    ...
    debug_print("[*] Fitting a logistic regression to labeled training data...")
    logit = logit.fit(trainDataVecs, train_data["sentiment"])
        

    # Test & extract results
    result = logit.predict(testDataVecs)
    ...
    # ****** Fit a logistic regression and extract predictions
    logit = LogisticRegression()

    # Fitting the logit may take a few minutes
    debug_print("[*] Fitting a logistic regression to labeled training data...")
    logit = logit.fit(train_centroids, train_data["sentiment"])
    result = logit.predict(test_centroids)
